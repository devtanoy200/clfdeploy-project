...
```
npm create cloudflare@latest -- --template=cloudflare/templates/ltsp
```

A live public deployment of this template is available at [https://ltsp.templates.workers.dev](https://ltsp.templates.workers.dev)
